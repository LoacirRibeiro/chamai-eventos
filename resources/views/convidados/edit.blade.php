<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-4">
            ...
            <a href="{{ route('events.show', $convidado->event_id) }}" class="w-10 h-10 flex items-center justify-center rounded-md bg-white border border-slate-100 text-slate-400 hover:text-indigo-600 transition shadow-sm">
            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-md border border-slate-100">
                <div class="p-10">
                    <div class="flex items-center gap-4 mb-10">
                        ...
                        <div class="w-12 h-12 bg-amber-500 rounded-md flex items-center justify-center text-white shadow-lg shadow-amber-100">
                    ...
                    <form action="{{ route('convidados.update', $convidado->id) }}" method="POST" class="space-y-6">
                        ...
                        <div class="pt-6 flex flex-col gap-3">
                            {{-- Botão Salvar --}}
                            <button type="submit" class="w-full bg-indigo-600 text-white py-4 rounded-md font-black text-xs uppercase tracking-[0.2em] hover:bg-indigo-700 transition shadow-xl shadow-indigo-100 flex items-center justify-center gap-2">
