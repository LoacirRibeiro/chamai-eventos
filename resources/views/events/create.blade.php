<x-app-layout>
    <x-slot name="header">
        ...
        <div class="flex items-center gap-4 px-2 sm:px-0">
            ...
            <h2 class="font-black text-[40px] sm:text-[40px] text-slate-800 tracking-tight">
            ...
            <div class="bg-white overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.04)] 
                ...
                <div class="p-5 sm:p-10">
                    ...
                    <div class="flex items-center gap-4 mb-6 sm:mb-10">
                        <div class="w-12 h-12 sm:w-14 sm:h-14 bg-indigo-600 rounded-md flex items-center justify-center text-white shadow-xl shadow-indigo-100 rotate-3 shrink-0">
                            <i class="fa-solid fa-wand-magic-sparkles text-xl sm:text-2xl"></i>
                        </div>

                        <div class="min-w-0">
                            <h3 class="text-base sm:text-[25px] font-black text-slate-800 uppercase tracking-tighter truncate">
                                O começo de tudo
                            </h3>
                            <p class="text-[12px] sm:text-[12px] text-slate-400 font-bold uppercase tracking-widest">
                    ...
                    <form action="{{ route('events.store') }}" method="POST" class="space-y-5 sm:space-y-6">
                        ...
                        <div>
                            <label class="block text-[11px] font-black uppercase text-slate-400 mb-1.5 ml-1 tracking-widest">
                                Nome da Celebração
                            </label>
                            ...
                            <div class="relative group">
                                ...
                                <input type="text" name="titulo" required
                                       ...
                                       class="w-full pl-11 pr-4 py-3.5 border border-slate-200 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 font-bold text-slate-700 placeholder:text-slate-300 text-sm sm:text-base transition-all">
                            </div>
                        </div>
                            ...
                            <div>
                                ...
                                <div class="relative group">
                                    ...
                                    <input type="datetime-local" name="data_horario" required
                                           class="w-full pl-11 pr-4 py-3.5 border border-slate-200 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 font-bold text-slate-700 text-sm">
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="relative group">
                                    ...
                                    <input type="text" name="local" required
                                           ...
                                           class="w-full pl-11 pr-4 py-3.5 border border-slate-200 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 font-bold text-slate-700 placeholder:text-slate-300 text-sm">
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="descricao" rows="3"
                                      ...
                                      class="w-full px-4 py-3.5 border border-slate-200 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 font-medium text-slate-700 placeholder:text-slate-300 text-sm"></textarea>
                        </div>

                        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pt-4">
                            <a href="{{ route('dashboard') }}"
                               class="order-2 sm:order-1 text-[12px] text-center font-black uppercase tracking-widest text-slate-400 hover:text-slate-600 transition">
                                Cancelar
                            </a>
