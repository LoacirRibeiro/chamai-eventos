...
<body class="bg-slate-50 font-sans antialiased">
        ...
        <div>
            @if (Route::has('login'))
                ...
                @else
                    ...
                    <a href="{{ route('register') }}" class="bg-indigo-600 text-white px-5 py-2 rounded-full font-bold hover:bg-indigo-700 transition shadow-lg shadow-indigo-200">Começar Grátis</a>
                @endauth
            @endif
        </div>
    </nav>
    ...
    <header class="max-w-7xl mx-auto px-6 py-16 text-center">
        ...
        <div class="flex flex-wrap justify-center gap-4">
            <a href="{{ route('register') }}" class="px-8 py-4 bg-slate-900 text-white rounded-2xl font-bold text-lg hover:scale-105 transition-transform shadow-xl">
